...
public class Admin_Action {
    public static Admin_Action login(String aid,Admin_Action adminact) {
        Admin_Action ad = new Admin_Action();
        int attempt=0;
        while (attempt<3){
            if(Admin.getAdminId().equals(aid)){
